...
export const SCENE_LAYOUT_MANIFEST = {
  ...
  assets: [
    ...
    { id: 'filing-cabinet', position: [-1.7, deskOrigin[1], deskOrigin[2] - 0.18], rotation: [0, 0.04, 0] },
    { id: 'desk-computer', position: computerPosition },
    { id: 'desk-lamp', position: deskLampPosition, rotation: [0, deskLampYaw, 0] },
    { id: 'receipt-printer', position: placeOnDesk(-1.08, -0.27), rotation: [0, 0.2, 0] },
    { id: 'desk-phone', position: placeOnDesk(-0.96, 0.24), rotation: [0, 0.27, 0] },
    { id: 'desk-calculator', position: placeOnDesk(-0.58, 0.1), rotation: [0, 0.1, 0] },
    { id: 'contractor-nameplate', position: placeOnDesk(-1.05, 0.48), rotation: [0, 0.36, 0], scale: 0.68 },
    { id: 'receipt-tray-set', position: placeOnDesk(0.96, -0.18), rotation: [0, -0.18, 0] },
    { id: 'freeze-card-button', position: placeOnDesk(0.72, 0.02), rotation: [0, -0.13, 0] },
    { id: 'fraud-stamp', position: placeOnDesk(0.68, 0.25), rotation: [0, -0.12, 0] },
    { id: 'reject-stamp', position: placeOnDesk(0.9, 0.35), rotation: [0, -0.19, 0] },
    { id: 'approval-stamp', position: placeOnDesk(1.1, 0.43), rotation: [0, -0.28, 0] },
    { id: 'desk-shredder', position: [1.35, deskOrigin[1], deskOrigin[2] + 0.16], rotation: [0, -0.12, 0] },
  ...
  camera: {
    ...
    player: { position: [0, 1.28, 1.19], target: [0, 0.99, 0.14], fov: 54 },
    ...
    workstation: { offset: [0, 0, 0.79] as SceneVector3, fov: 27 },
